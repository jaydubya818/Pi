...
- **Teams & chains** — `teams.yaml` rosters, `agent-chain.yaml` pipelines (orchestration playground)
- **Safety rules** — `damage-control-rules.yaml` patterns and path policies
- **Docs** — README / `docs/pi-playground/` tier pages, `examples/meta-agent/` prompt packs
...
- Meta prompts & templates: `examples/meta-agent/`
- Tier docs: `docs/pi-playground/TIER3-META-AGENT.md`